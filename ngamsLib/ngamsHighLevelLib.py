...
#******************************************************************************
#
# "@(#) $Id: ngamsHighLevelLib.py,v 1.12 2012/03/03 21:04:50 amanning Exp $"
#
# Who       When        What
# --------  ----------  -------------------------------------------------------
...
def openCheckUri(uri, startByte = 0):
    """
    ...
    try:
        ...
        request.add_header('Range', str(startByte) + '-')
        retStat = urllib2.urlopen(request)
    except Exception, e:
        err = str(e)
