...
#******************************************************************************
#
# "@(#) $Id: ngamsReqProps.py,v 1.8 2012/03/03 21:05:46 amanning Exp $"
#
# Who       When        What
# --------  ----------  -------------------------------------------------------
...
class ngamsReqProps:
    ...
    def __init__(self):
        ...
        # added for ALMA. Keeps track of the individual parts regarding the file information
        self.__fileInformation = {}
    ...
    def unpackHttpInfo(self,
        ...
        for key in headers.keys():
            ...
            if (keyTmp == "content-disposition"):
                ...
                info(3, "Range HEADER: value is " + val)
                # we don't handle the full range syntax according to the HTTP spec. 
                # only startByte until end. unpack
                
                self.setRange(int(val.replace('-', '').strip()))
    ...
    def setChecksum(self, checksum):
        self.__sourceChecksum = checksum
        
    def getChecksum(self):
        return self.__sourceChecksum
    ...
    def setFileInfo(self, fileInformation):
        self.__fileInformation = fileInformation

    def getFileInfo(self):
        return self.__fileInformation
# EOF
