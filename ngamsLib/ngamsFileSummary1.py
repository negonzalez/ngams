...
#******************************************************************************
#
# "@(#) $Id: ngamsFileSummary1.py,v 1.5 2010/12/01 16:30:56 jagonzal Exp $"
#
# Who       When        What
# --------  ----------  -------------------------------------------------------
...
class ngamsFileSummary1:
    ...
    def setFormat(self,
                  format):
        """
        Set the format member of the class.

        format: Mime Type of the file 
    ...
    def getFormat(self):
        """
        Return the value of the format member.

        Returns:  Value of format member (string).
        """
    ...
    def unpackSqlInfo(self,
        ...
        self.\
               ...
               setFormat(sqlInfo[ngamsDbCore.SUM1_FORMAT])
