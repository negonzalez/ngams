...
#******************************************************************************
#
# "@(#) $Id: ngamsCmd_QARCHIVE.py,v 1.7 2011/02/17 00:39:56 jagonzal Exp $"
#
# Who       When        What
# --------  ----------  -------------------------------------------------------
...
def handleCmd(srvObj,
    ...
    info(3, "Triggering SubscriptionThread")
	...
	info(3, "Triggering CacheControlThread")
        diskId      = resDapi.getDiskId()
        fileId      = resDapi.getFileId()
        fileVersion = resDapi.getFileVersion()
        filename    = resDapi.getRelFilename()
        ngamsCacheControlThread.addEntryNewFilesDbm(srvObj, diskId, fileId, fileVersion, filename)
