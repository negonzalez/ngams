...
#******************************************************************************
#
# "@(#) $Id: ngamsCloneCmdTest.py,v 1.7 2010/10/04 19:13:26 jagonzal Exp $"
#
# Who       When        What
# --------  ----------  -------------------------------------------------------
...
def _execCloneTest(testObj,
    ...
    if (checkNotifEmail):
        ...
        # jagonzal: filter out file list (CLONE cmd)
        mailCont = mailCont.split("==File List:")[0]
...
class ngamsCloneCmdTest(ngamsTestSuite):
    ...
    def test_CloneCmd_1(self):
        ...
        # jagonzal: The first clone command seems to store the files in FitsStorage1-Main-1
        tmpFitsFile = "/tmp/ngamsTest/NGAS/FitsStorage1-Main-1/saf/" +\
